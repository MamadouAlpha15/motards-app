...
<form method="GET" action="{{ route('motards.index') }}" class="mb-4">
    <div class="input-group">
        <input type="text" name="recherche" class="form-control" placeholder="Rechercher par nom, ligne ou matricule" value="{{ request('recherche') }}">
                ...
                @foreach($motards as $motard)
                    <tr>
                        ...
                        <td class="text-center">
                            <div style="border: 1px solid #ccc; padding: 10px; border-radius: 10px; width: fit-content; margin: auto;">
                                {{-- Photo --}}
